...
@Component
public class ObtenerEstadoReservaMapper {
    
    public ObtenerEstadoReservaResponseDto entityToResponse(EstadoReserva entity) {
        if (entity == null) {
            return null;
        }
        ObtenerEstadoReservaResponseDto responseDto = new ObtenerEstadoReservaResponseDto();
