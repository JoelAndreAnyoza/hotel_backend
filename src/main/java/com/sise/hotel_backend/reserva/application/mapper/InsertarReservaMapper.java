...
@Component
public class InsertarReservaMapper implements IEntityDtoMapper
<Reserva, InsertarReservaRequestDto, InsertarReservaResponseDto>{

    @Override
    public Reserva requestToEntity(InsertarReservaRequestDto requestDto) {
    ...
    @Override
    public InsertarReservaResponseDto entityToResponse(Reserva entity) {
        InsertarReservaResponseDto responseDto = new InsertarReservaResponseDto();
